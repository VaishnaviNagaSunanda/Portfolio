                ...
                <div className="bg-cream/90 dark:bg-black/90 backdrop-blur-xl rounded-[22px] p-8 md:p-12 border border-brown/20 dark:border-neon-green/20 shadow-[0_0_30px_rgba(74,59,50,0.1)] dark:shadow-[0_0_30px_rgba(34,197,94,0.15)] h-full transition-colors">
                    ...
                    <div className="flex flex-col md:flex-row gap-12">
                        ...
                        <div className="flex-1 space-y-8" style={{ transform: "translateZ(20px)" }}>
                            <a href="https://wa.me/918688337723" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-gray-600 dark:text-gray-300 transition-colors cursor-pointer">
                                ...
                                <span className="font-medium tracking-wide">+91 8688337723</span>
                            </a>
                            <a href="mailto:vaishnaviparasa2004@gmail.com" className="group flex items-center gap-4 text-gray-600 dark:text-gray-300 transition-colors cursor-pointer">
                                <div className="w-12 h-12 rounded-lg bg-brown/10 dark:bg-neon-green/10 flex items-center justify-center text-brown dark:text-neon-green group-hover:scale-110 group-hover:shadow-lg transition-all">
                                    <Mail size={20} />
                                </div>
                                <span className="font-medium tracking-wide">vaishnaviparasa2004@gmail.com</span>
                            </a>
                        ...
                        <form onSubmit={handleSubmit} className="flex-[1.5] space-y-6" style={{ transform: "translateZ(50px)" }}>
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="w-full bg-brown dark:bg-neon-green text-white dark:text-black font-bold py-4 rounded-lg flex items-center justify-center gap-2 hover:bg-light-brown dark:hover:bg-neon-green/80 hover:shadow-lg transition-all"
                            >
